...
public class WicketPortlet extends GenericPortlet {
    ...
    protected String getWicketURL(final PortletRequest request, final PageType pageType, final String defaultPage) {
        ...
        if (request instanceof ActionRequest) {
            ...
            // the portlet mode
            final String redirectUrlKey = WICKET_URL_PORTLET_PARAMETER + request.getPortletMode().toString();
    ...
    public void init(final PortletConfig config) throws PortletException {
        ...
        final String responseBufferFolderPath = config.getInitParameter(RESPONSE_BUFFER_FOLDER_PARAM);
     ...
     * @throws IOException
     */
    protected void processActionResponseState(final String wicketURL, final PortletRequest request,
     ...
     * @throws IOException
     */
    private void processMimeResponseRequest(String wicketURL, final PortletRequest request, final MimeResponse response,
            final ResponseState responseState) throws PortletException, IOException {
        ...
        while (true) {
            ...
            if (rd != null) {
                ...
                final String redirectLocation = responseState.getRedirectLocation();
                final String ajaxRedirectLocation = responseState.getAjaxRedirectLocation();
     ...
     * @throws IOException
     */
    protected void processRequest(final PortletRequest request, final PortletResponse response, final PageType pageType)
            throws PortletException, IOException {
        String wicketURL = null;
