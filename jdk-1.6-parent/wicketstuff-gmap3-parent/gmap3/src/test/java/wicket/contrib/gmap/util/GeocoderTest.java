...
public class GeocoderTest {
	...
	public void testEncode() {
		...
		final String encode = coder.encode("Salzburgerstraße 205, 4030 Linz, Österreich");
		Assert.assertEquals(
	...
	public void testGeocoding() throws Exception {
		...
		final Geocoder coder = new Geocoder();
		final GLatLng result = coder.geocode("Salzburgerstraße 205, 4030 Linz, Österreich");
