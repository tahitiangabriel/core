...
public class ManyPage extends WicketExamplePage {
	...
	public ManyPage() {
		final AjaxFallbackLink<Void> create = new AjaxFallbackLink<Void>("create") {
			private static final long serialVersionUID = 1L;
	...
	protected void addPanel() {
		final ManyPanel newPanel = new ManyPanel(repeating.newChildId()) {
			private static final long serialVersionUID = 1L;

			@Override
			protected void closing(final AjaxRequestTarget target) {
